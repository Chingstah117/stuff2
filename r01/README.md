...
Below is a short list of the most basic commands you will use on a day to day basis:
...
## Editor
You *have to* learn to use one editor, either `vim`, `emacs` or `sublime`.  We introduce `vim` here because
...
### Exercise 1 (Please submit the Makefile and hello.c. The Makefile should also contain the debug flag discussed in exercise 2)
...
### Exercise 3 (Here is where you submit all your files)
